...
$scriptUrl = "https://raw.githubusercontent.com/microsoft/build-2025-devcenter/refs/heads/jyotilama/test-onbehalf-feature/BuildLab/life-cycle-scripts/create-devbox-onbehalf.ps1"
